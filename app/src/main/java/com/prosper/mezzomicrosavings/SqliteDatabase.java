...
public class SqliteDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String	CREATE_CONTACTS_TABLE = "CREATE	TABLE " + TABLE_CONTACTS + "(" + COLUMN_ID + " INTEGER PRIMARY KEY," + COLUMN_NAME + " TEXT," + COLUMN_BALANCE + " TEXT," + COLUMN_NO + " TEXT);";
    ...
    public ArrayList<Contacts> listContacts(){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                storeContacts.add(new Contacts(id, name, balance, phno));
    ...
    public void addContacts(Contacts contacts){
        ...
        values.put(COLUMN_BALANCE, contacts.getBalance());
    ...
    public void updateBalance(Contacts contacts){
        ContentValues values = new ContentValues();
        values.put(COLUMN_BALANCE, contacts.getBalance());
        SQLiteDatabase db = this.getWritableDatabase();
        db.update(TABLE_CONTACTS, values, COLUMN_ID	+ "	= ?", new String[] { String.valueOf(contacts.getId())});
    ...
    public Contacts findContacts(String name){
        ...
        if	(cursor.moveToFirst()){
            ...
            String contactsBalance = cursor.getString(2);
            String contactsNo = cursor.getString(3);
            contacts = new Contacts(id, contactsName, contactsBalance, contactsNo);
        }
        cursor.close();
        return contacts;
    }
